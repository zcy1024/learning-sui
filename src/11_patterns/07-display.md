...
本章介绍 **Display V1**（`sui::display`）的设计背景、创建方式、模板语法以及最佳实践。新一代 **Display V2** 基于 Display Registry（系统对象 `0xd`），支持每类型一个 Display、固定查询点与迁移路径，详见 [10.8 Display V2 与 Display Registry](08-display-v2.md)。
